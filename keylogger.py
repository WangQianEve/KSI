...
def log(key,kill):
    '''
    This function should be called as a new process. It get system key status and change argument "key" based on that.
    Input:
        key: dict
            info: the key that was pressed
            status: whether a key event is happening
        kill: should this process end or not
    '''
    while not kill['kill']:
